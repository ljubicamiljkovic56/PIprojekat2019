...
function searchByBrojOtpremnice(){
	...
	$("#doSearch").on("click", function(event) {
		...
		$.ajax({
			url : "http://localhost:8080/api/otpremnice/searchByBrojOtpremnice?pageNo=" + pageNo + "&pageSize=" + pageSize + "&broj=" + broj
		}).then(
				function(data, status, request) {
					console.log(data);
					otpremnicaPagination.empty();
...
function searchByKupac(){
	...
	$("#doSearch").on("click", function(event) {
		...
		$.ajax({
			url : "http://localhost:8080/api/otpremnice/searchByKupac?pageNo=" + pageNo + "&pageSize=" + pageSize + "&kupac=" + kupac
		}).then(
				function(data, status, request) {
					console.log(data);
					otpremnicaPagination.empty();
...
function searchByPrevoznik(){
	...
	$("#doSearch").on("click", function(event) {
		...
		$.ajax({
			url : "http://localhost:8080/api/otpremnice/searchByPrevoznik?pageNo=" + pageNo + "&pageSize=" + pageSize + "&prevoznik=" + prevoznik
		}).then(
				function(data, status, request) {
					console.log(data);
					otpremnicaPagination.empty();
